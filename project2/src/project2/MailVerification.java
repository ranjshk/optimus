...
public class MailVerification extends javax.swing.JFrame {
    ...
    private void SendOtpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SendOtpActionPerformed
        ...
        try {
            Email email = new Email("bankofclogne@gmail.com","netfdgcksaiibzxq");    // email and password 
            email.setFrom("bankofclogne@gmail.com","Bank of Cologne");   // email only
            email.setSubject("Account Verification by Bank of Cologne");
            email.setContent("<h1>Welcome To Bank of Cologne</h1><p>Thank You! For Verifying Your Email. Your OTP is</p>"+Otp,"text/html");
